...
lval wile_map(lptr*, lptr);	// (map proc lst . ls)
...
lval wile_build_info(lptr*, lptr);	// (wile-build-info add-ctime?)
...
lval wile_root_bracket(lptr*, lptr);	// (root-bracket f x scale)
lval wile_root_bisect(lptr*, lptr);	// (root-bisect et fn a0 b0)
lval wile_root_ridders(lptr*, lptr);	// (root-ridders et fn a0 b0)
lval wile_curry(lptr*, lptr);	// (curry func arg1)
lval wile_compose(lptr*, lptr);	// (compose f . fs)
lval wile_list_group_by(lptr*, lptr);	// (list-group-by cmp lst)
lval wile_mr_primality(lptr*, lptr);	// (is-prime? n . k)
lval wile_next_prime(lptr*, lptr);	// (next-prime n)
...
lval wile_eval_load_path(lptr*, lptr);	// (load-file-path pathy? fname)
lval wile_eval_load_form(lptr*, lptr);	// (load-form? expr)
lval wile_eval_begin_form(lptr*, lptr);	// (begin-form? expr)
lval wile_eval_define(lptr*, lptr);	// (eval-define macro env expr)
lval wile_eval_begin(lptr*, lptr);	// (eval-begin ebox env expr)
