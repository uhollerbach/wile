...
// @@@ lambda (arg fns) @@@ bld-rtl-dir/wile-rtl2-000079.scm:16 @@@ fn_11 @@@
...
var_13[0] = var_25[0];
var_13[1] = var_25[1];
// bld-rtl-dir/wile-rtl2-000079.scm:20
goto lbl_14;	// selfie
} else {
var_15 = var_13[0];
}
...
// @@@ lambda args @@@ bld-rtl-dir/wile-rtl2-000079.scm:15 @@@ fn_7 @@@
...
var_31[0] = var_27;
var_31[1] = var_29;
// bld-rtl-dir/wile-rtl2-000079.scm:16
var_30 = fn_11(var_12, var_31, "bld-rtl-dir/wile-rtl2-000079.scm:16");
return var_30;
}
// end of lambda fn_7

// @@@ (compose f . fs) @@@ bld-rtl-dir/wile-rtl2-000079.scm:13 @@@ wile_compose @@@
...
lval var_6[8];
var_6[0] = var_4;
// bld-rtl-dir/wile-rtl2-000079.scm:14
var_5 = wile_list_reverse(NULL, var_6, "bld-rtl-dir/wile-rtl2-000079.scm:14");
}
var_2[1] = var_5;
MK_CLOS(var_8,1);
