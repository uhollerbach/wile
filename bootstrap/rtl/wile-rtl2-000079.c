...
// @@@ (bracket-error) @@@ bld-rtl-dir/wile-rtl2-000079.scm:13 @@@ fn_1 @@@
...
cachalot->whence = "bld-rtl-dir/wile-rtl2-000079.scm:14";
longjmp(cachalot->cenv, 1);
return var_9;
}
// end of function fn_1

// @@@ (budget-error val) @@@ bld-rtl-dir/wile-rtl2-000079.scm:16 @@@ fn_2 @@@
...
cachalot->whence = "bld-rtl-dir/wile-rtl2-000079.scm:17";
longjmp(cachalot->cenv, 1);
return var_17;
}
// end of function fn_2

// @@@ (exact v) @@@ bld-rtl-dir/wile-rtl2-000079.scm:19 @@@ fn_3 @@@
...
// @@@ (approx v v1 v2) @@@ bld-rtl-dir/wile-rtl2-000079.scm:22 @@@ fn_4 @@@
...
lval var_29[8];
var_29[0] = var_28;
var_28 = wile_subtract(NULL, var_29, "bld-rtl-dir/wile-rtl2-000079.scm:23");
}
lval var_31;
switch (var_28.vt) {
case LV_INT:
...
break;
default:
wile_exception("abs", "bld-rtl-dir/wile-rtl2-000079.scm:23", "got a non-numeric argument");
}
lval var_32;
{
lval var_33[2];
...
// @@@ lambda (s) @@@ bld-rtl-dir/wile-rtl2-000079.scm:28 @@@ fn_37 @@@
...
lval var_43[8];
var_43[0] = var_42;
var_42 = wile_subtract(NULL, var_43, "bld-rtl-dir/wile-rtl2-000079.scm:29");
}
var_41 = var_42;
lval var_45;
lval var_46;
...
lval var_47[8];
var_47[0] = var_46;
var_46 = wile_add(NULL, var_47, "bld-rtl-dir/wile-rtl2-000079.scm:30");
}
var_45 = var_46;
lval var_49;
lval var_50;
...
var_52 = wile_apply_function(&(var_52), "bld-rtl-dir/wile-rtl2-000079.scm:31");
var_49 = var_52;
lval var_54;
lval var_55;
{
...
var_57 = wile_apply_function(&(var_57), "bld-rtl-dir/wile-rtl2-000079.scm:32");
var_54 = var_57;
lval var_59;
lval var_60;
switch (var_49.vt) {
...
break;
default:
wile_exception("sign", "bld-rtl-dir/wile-rtl2-000079.scm:33", "got a non-real-valued argument");
}
lval var_61;
switch (var_54.vt) {
case LV_INT:
...
break;
default:
wile_exception("!=", "bld-rtl-dir/wile-rtl2-000079.scm:33", "inputs are not real-valued numbers");
break;
}
...
lval var_65[8];
var_65[0] = var_64;
var_64 = wile_multiply(NULL, var_65, "bld-rtl-dir/wile-rtl2-000079.scm:35");
}
lval var_67;
lval var_69[8];
var_69[0] = var_64;
...
// @@@ (root-bracket f x scale) @@@ bld-rtl-dir/wile-rtl2-000079.scm:27 @@@ wile_root_bracket @@@
...
lval var_75[8];
var_75[0] = var_35[2];
var_74 = fn_37(var_38, var_75, "bld-rtl-dir/wile-rtl2-000079.scm:28");
*var_72 = var_35[0];
*var_73 = var_35[1];
return var_74;
}
...
// @@@ lambda (ne a fa b fb) @@@ bld-rtl-dir/wile-rtl2-000079.scm:45 @@@ fn_93 @@@
...
lval var_100[8];
var_100[0] = var_99;
var_99 = wile_add(NULL, var_100, "bld-rtl-dir/wile-rtl2-000079.scm:46");
}
lval var_102;
{
lval var_104[2];
...
lval var_103[8];
var_103[0] = var_102;
var_102 = wile_multiply(NULL, var_103, "bld-rtl-dir/wile-rtl2-000079.scm:46");
}
var_97 = var_102;
lval var_105;
lval var_106;
...
var_108 = wile_apply_function(&(var_108), "bld-rtl-dir/wile-rtl2-000079.scm:47");
var_105 = var_108;
lval var_110;
lval var_111;
lval var_112[8];
...
var_112[1] = var_95[1];
var_112[2] = var_95[3];
var_111 = fn_4(NULL, var_112, "bld-rtl-dir/wile-rtl2-000079.scm:48");
var_110 = var_111;
lval var_114;
lval var_115;
var_115 = LVI_INT(1);
...
lval var_117[8];
var_117[0] = var_116;
var_116 = wile_subtract(NULL, var_117, "bld-rtl-dir/wile-rtl2-000079.scm:49");
}
var_114 = var_116;
lval var_119;
lval var_121;
...
break;
default:
wile_exception("zero?", "bld-rtl-dir/wile-rtl2-000079.scm:50", "expects a real-valued number");
}
...
var_124[0] = var_110;
var_95[0] = var_124[0];
TAIL_CALL fn_2(NULL, var_95, "bld-rtl-dir/wile-rtl2-000079.scm:50");
var_119 = var_122;
goto lbl_120;
}
lval var_125;
...
break;
default:
wile_exception("zero?", "bld-rtl-dir/wile-rtl2-000079.scm:51", "expects a real-valued number");
}
...
var_128[0] = var_97;
var_95[0] = var_128[0];
TAIL_CALL fn_3(NULL, var_95, "bld-rtl-dir/wile-rtl2-000079.scm:51");
var_119 = var_126;
goto lbl_120;
}
lval var_129;
...
var_131 = wile_apply_function(&(var_131), "bld-rtl-dir/wile-rtl2-000079.scm:52");
...
break;
default:
wile_exception("negative?", "bld-rtl-dir/wile-rtl2-000079.scm:53", "expects a real-valued number");
}
...
var_136 = wile_apply_function(&(var_136), "bld-rtl-dir/wile-rtl2-000079.scm:53");
var_119 = var_136;
goto lbl_120;
}
lval var_138;
...
var_140 = wile_apply_function(&(var_140), "bld-rtl-dir/wile-rtl2-000079.scm:54");
var_119 = var_140;
lbl_120:;
return var_119;
}
...
// @@@ (root-bisect et fn a0 b0) @@@ bld-rtl-dir/wile-rtl2-000079.scm:41 @@@ wile_root_bisect @@@
...
var_86 = wile_apply_function(&(var_86), "bld-rtl-dir/wile-rtl2-000079.scm:42");
var_80 = var_86;
lval var_88;
{
lval var_89[1];
...
var_90 = wile_apply_function(&(var_90), "bld-rtl-dir/wile-rtl2-000079.scm:43");
var_81 = var_90;
lval var_92;
var_92 = LVI_INT(128);
var_82 = var_92;
...
break;
default:
wile_exception("zero?", "bld-rtl-dir/wile-rtl2-000079.scm:55", "expects a real-valued number");
}
...
var_150[0] = var_78[2];
var_78[0] = var_150[0];
TAIL_CALL fn_3(NULL, var_78, "bld-rtl-dir/wile-rtl2-000079.scm:55");
var_145 = var_148;
goto lbl_146;
}
lval var_151;
...
break;
default:
wile_exception("zero?", "bld-rtl-dir/wile-rtl2-000079.scm:56", "expects a real-valued number");
}
...
var_154[0] = var_78[3];
var_78[0] = var_154[0];
TAIL_CALL fn_3(NULL, var_78, "bld-rtl-dir/wile-rtl2-000079.scm:56");
var_145 = var_152;
goto lbl_146;
}
lval var_155;
...
break;
default:
wile_exception("sign", "bld-rtl-dir/wile-rtl2-000079.scm:57", "got a non-real-valued argument");
}
lval var_156;
switch (var_81.vt) {
case LV_INT:
...
break;
default:
wile_exception("==", "bld-rtl-dir/wile-rtl2-000079.scm:57", "inputs are not real-valued numbers");
break;
}
if (!LV_IS_FALSE(var_157)) {
lval var_158;
TAIL_CALL fn_1(NULL, var_78, "bld-rtl-dir/wile-rtl2-000079.scm:57");
var_145 = var_158;
goto lbl_146;
}
lval var_161;
...
break;
default:
wile_exception("negative?", "bld-rtl-dir/wile-rtl2-000079.scm:58", "expects a real-valued number");
}
...
var_164 = wile_apply_function(&(var_164), "bld-rtl-dir/wile-rtl2-000079.scm:58");
var_145 = var_164;
goto lbl_146;
}
lval var_166;
...
var_168 = wile_apply_function(&(var_168), "bld-rtl-dir/wile-rtl2-000079.scm:59");
var_145 = var_168;
lbl_146:;
*var_142 = var_83;
*var_144 = var_78[1];
...
// @@@ lambda (ne a fa b fb) @@@ bld-rtl-dir/wile-rtl2-000079.scm:94 @@@ fn_186 @@@
...
lval var_193[8];
var_193[0] = var_192;
var_192 = wile_add(NULL, var_193, "bld-rtl-dir/wile-rtl2-000079.scm:95");
}
lval var_195;
{
lval var_197[2];
...
lval var_196[8];
var_196[0] = var_195;
var_195 = wile_multiply(NULL, var_196, "bld-rtl-dir/wile-rtl2-000079.scm:95");
}
var_190 = var_195;
lval var_198;
lval var_199;
...
var_201 = wile_apply_function(&(var_201), "bld-rtl-dir/wile-rtl2-000079.scm:96");
var_198 = var_201;
lval var_203;
lval var_204;
{
...
lval var_205[8];
var_205[0] = var_204;
var_204 = wile_subtract(NULL, var_205, "bld-rtl-dir/wile-rtl2-000079.scm:97");
}
lval var_207;
{
lval var_209[2];
...
lval var_208[8];
var_208[0] = var_207;
var_207 = wile_subtract(NULL, var_208, "bld-rtl-dir/wile-rtl2-000079.scm:97");
}
lval var_210;
switch (var_207.vt) {
case LV_INT:
...
break;
default:
wile_exception("sign", "bld-rtl-dir/wile-rtl2-000079.scm:97", "got a non-real-valued argument");
}
lval var_211;
{
lval var_213[3];
...
lval var_212[8];
var_212[0] = var_211;
var_211 = wile_multiply(NULL, var_212, "bld-rtl-dir/wile-rtl2-000079.scm:97");
}
lval var_214;
{
lval var_216[2];
...
lval var_215[8];
var_215[0] = var_214;
var_214 = wile_multiply(NULL, var_215, "bld-rtl-dir/wile-rtl2-000079.scm:98");
}
lval var_217;
{
lval var_219[2];
...
lval var_218[8];
var_218[0] = var_217;
var_217 = wile_multiply(NULL, var_218, "bld-rtl-dir/wile-rtl2-000079.scm:98");
}
lval var_220;
{
lval var_222[2];
...
lval var_221[8];
var_221[0] = var_220;
var_220 = wile_subtract(NULL, var_221, "bld-rtl-dir/wile-rtl2-000079.scm:98");
}
lval var_224;
...
wile_exception("sqrt", "bld-rtl-dir/wile-rtl2-000079.scm:98", "expects one numeric argument");
}
lval var_225;
{
lval var_227[2];
...
lval var_226[8];
var_226[0] = var_225;
var_225 = wile_divide(NULL, var_226, "bld-rtl-dir/wile-rtl2-000079.scm:97");
}
lval var_228;
{
lval var_230[2];
...
lval var_229[8];
var_229[0] = var_228;
var_228 = wile_add(NULL, var_229, "bld-rtl-dir/wile-rtl2-000079.scm:97");
}
var_203 = var_228;
lval var_231;
lval var_232;
...
var_234 = wile_apply_function(&(var_234), "bld-rtl-dir/wile-rtl2-000079.scm:99");
var_231 = var_234;
lval var_236;
lval var_237;
lval var_238[8];
...
var_238[1] = var_190;
var_238[2] = var_203;
var_237 = fn_4(NULL, var_238, "bld-rtl-dir/wile-rtl2-000079.scm:100");
var_236 = var_237;
lval var_240;
lval var_241;
var_241 = LVI_INT(1);
...
lval var_243[8];
var_243[0] = var_242;
var_242 = wile_subtract(NULL, var_243, "bld-rtl-dir/wile-rtl2-000079.scm:101");
}
var_240 = var_242;
lval var_245;
lval var_247;
...
break;
default:
wile_exception("zero?", "bld-rtl-dir/wile-rtl2-000079.scm:102", "expects a real-valued number");
}
...
var_250[0] = var_236;
var_188[0] = var_250[0];
TAIL_CALL fn_2(NULL, var_188, "bld-rtl-dir/wile-rtl2-000079.scm:102");
var_245 = var_248;
goto lbl_246;
}
lval var_251;
...
break;
default:
wile_exception("zero?", "bld-rtl-dir/wile-rtl2-000079.scm:103", "expects a real-valued number");
}
...
var_254[0] = var_190;
var_188[0] = var_254[0];
TAIL_CALL fn_3(NULL, var_188, "bld-rtl-dir/wile-rtl2-000079.scm:103");
var_245 = var_252;
goto lbl_246;
}
lval var_255;
...
break;
default:
wile_exception("zero?", "bld-rtl-dir/wile-rtl2-000079.scm:104", "expects a real-valued number");
}
...
var_258[0] = var_203;
var_188[0] = var_258[0];
TAIL_CALL fn_3(NULL, var_188, "bld-rtl-dir/wile-rtl2-000079.scm:104");
var_245 = var_256;
goto lbl_246;
}
lval var_259;
...
var_261 = wile_apply_function(&(var_261), "bld-rtl-dir/wile-rtl2-000079.scm:105");
...
break;
default:
wile_exception("sign", "bld-rtl-dir/wile-rtl2-000079.scm:106", "got a non-real-valued argument");
}
lval var_264;
switch (var_198.vt) {
case LV_INT:
...
break;
default:
wile_exception("!=", "bld-rtl-dir/wile-rtl2-000079.scm:106", "inputs are not real-valued numbers");
break;
}
...
var_268 = wile_apply_function(&(var_268), "bld-rtl-dir/wile-rtl2-000079.scm:106");
var_245 = var_268;
goto lbl_246;
}
lval var_270;
...
break;
default:
wile_exception("sign", "bld-rtl-dir/wile-rtl2-000079.scm:107", "got a non-real-valued argument");
}
lval var_271;
switch (var_188[2].vt) {
case LV_INT:
...
break;
default:
wile_exception("!=", "bld-rtl-dir/wile-rtl2-000079.scm:107", "inputs are not real-valued numbers");
break;
}
...
var_275 = wile_apply_function(&(var_275), "bld-rtl-dir/wile-rtl2-000079.scm:107");
var_245 = var_275;
goto lbl_246;
}
lval var_277;
...
var_279 = wile_apply_function(&(var_279), "bld-rtl-dir/wile-rtl2-000079.scm:108");
var_245 = var_279;
lbl_246:;
return var_245;
}
...
// @@@ (root-ridders et fn a0 b0) @@@ bld-rtl-dir/wile-rtl2-000079.scm:90 @@@ wile_root_ridders @@@
...
var_179 = wile_apply_function(&(var_179), "bld-rtl-dir/wile-rtl2-000079.scm:91");
var_173 = var_179;
lval var_181;
{
lval var_182[1];
...
var_183 = wile_apply_function(&(var_183), "bld-rtl-dir/wile-rtl2-000079.scm:92");
var_174 = var_183;
lval var_185;
var_185 = LVI_INT(128);
var_175 = var_185;
...
break;
default:
wile_exception("zero?", "bld-rtl-dir/wile-rtl2-000079.scm:109", "expects a real-valued number");
}
...
var_289[0] = var_171[2];
var_171[0] = var_289[0];
TAIL_CALL fn_3(NULL, var_171, "bld-rtl-dir/wile-rtl2-000079.scm:109");
var_284 = var_287;
goto lbl_285;
}
lval var_290;
...
break;
default:
wile_exception("zero?", "bld-rtl-dir/wile-rtl2-000079.scm:110", "expects a real-valued number");
}
...
var_293[0] = var_171[3];
var_171[0] = var_293[0];
TAIL_CALL fn_3(NULL, var_171, "bld-rtl-dir/wile-rtl2-000079.scm:110");
var_284 = var_291;
goto lbl_285;
}
lval var_294;
...
break;
default:
wile_exception("sign", "bld-rtl-dir/wile-rtl2-000079.scm:111", "got a non-real-valued argument");
}
lval var_295;
switch (var_174.vt) {
case LV_INT:
...
break;
default:
wile_exception("==", "bld-rtl-dir/wile-rtl2-000079.scm:111", "inputs are not real-valued numbers");
break;
}
if (!LV_IS_FALSE(var_296)) {
lval var_297;
TAIL_CALL fn_1(NULL, var_171, "bld-rtl-dir/wile-rtl2-000079.scm:111");
var_284 = var_297;
goto lbl_285;
}
lval var_300;
...
var_302 = wile_apply_function(&(var_302), "bld-rtl-dir/wile-rtl2-000079.scm:112");
var_284 = var_302;
lbl_285:;
*var_281 = var_176;
*var_283 = var_171[1];
