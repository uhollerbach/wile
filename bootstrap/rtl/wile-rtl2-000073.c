...
var_31[1] = var_27;
var_31[2] = var_30;
var_30 = wile_map(NULL, var_31);
}
lval var_33;
lval var_34[8];
var_34[0] = var_15;
var_34[1] = var_30;
var_33 = fn_4(NULL, var_34);
lval var_36;
{
...
static lval fn_5(lptr* var_38, lptr var_39)
{
lval var_41;
lval var_42;
switch (var_39[0].vt) {
...
lval var_46[8];
var_46[0] = var_45;
var_45 = wile_subtract(NULL, var_46);
}
lval var_48;
...
static lval fn_6(lptr* var_66, lptr var_67)
{
lval var_69;
lval var_70;
...
lval var_82[8];
var_82[0] = var_80;
var_81 = wile_list_reverse(NULL, var_82);
}
lval var_83;
...
static lval fn_7(lptr* var_90, lptr var_91)
{
lval var_93;
var_93 = LVI_INT(0);
lval var_94;
...
lval var_95[8];
var_95[0] = var_91[0];
var_94 = wile_list_length(NULL, var_95);
}
lval var_96;
lval var_97[8];
var_97[0] = var_93;
var_97[1] = var_94;
var_97[2] = var_91[0];
var_96 = fn_6(NULL, var_97);
lval var_99;
{
lval var_100[8];
var_100[0] = var_96;
var_99 = wile_list_reverse(NULL, var_100);
}
return var_99;
}
// end of function fn_7

// @@@ lambda (m v) @@@ bld-rtl-dir/wile-rtl2-000073.scm:37 @@@ fn_109 @@@
static lval fn_109(lptr* var_110, lptr var_111)
{
lval var_113;
{
lval var_115[2];
...
lval var_114[8];
var_114[0] = var_113;
var_113 = wile_divide(NULL, var_114);
}
return var_113;
}
...
lval var_107[8];
var_107[0] = var_103;
var_106 = fn_7(NULL, var_107);
MK_CLOS(var_110,0);
lval var_116;
lval var_117[8];
var_117[0] = var_103;
var_117[1] = var_2[1];
var_116 = fn_4(NULL, var_117);
lval var_119;
{
lval var_121[1];
var_121[0] = var_116;
...
var_125[0] = var_106;
var_125[1] = var_122;
var_124 = fn_4(NULL, var_125);
lval var_127;
{
lval var_128[8];
var_128[0] = var_124;
var_127 = wile_list_reverse(NULL, var_128);
}
return var_127;
}
