...
// @@@ vector-length @@@ bld-rtl-dir/wile-rtl2-000073.scm:15 @@@ fn_7 @@@
...
wile_exception("vector-length", "bld-rtl-dir/wile-rtl2-000073.scm:15", "input is not a vector");
}
}
return var_11;
}
...
// @@@ lambda (v) @@@ bld-rtl-dir/wile-rtl2-000073.scm:21 @@@ fn_47 @@@
static lval fn_47(lptr* var_48, lptr var_49, const char* cloc)
{
lval var_51;
{
if (var_49[0].vt != LV_VECTOR) {
wile_exception("vector-ref", "bld-rtl-dir/wile-rtl2-000073.scm:21", "input is not a vector");
}
if (V_CLOS(var_48,0).vt != LV_INT || V_CLOS(var_48,0).v.iv < 0 || (size_t) V_CLOS(var_48,0).v.iv >= var_49[0].v.vec.capa) {
wile_exception("vector-ref", "bld-rtl-dir/wile-rtl2-000073.scm:21", "got bad index value");
}
...
// @@@ (vector-for-each proc vec . vecs) @@@ bld-rtl-dir/wile-rtl2-000073.scm:13 @@@ wile_vector_foreach @@@
...
var_53[1] = var_4;
var_53[2] = var_52;
var_52 = wile_map(NULL, var_53, "bld-rtl-dir/wile-rtl2-000073.scm:21");
}
lval var_54;
{
lval var_55[2];
...
var_54 = wile_apply_function(&(var_54), "bld-rtl-dir/wile-rtl2-000073.scm:21");
lval var_56;
var_56 = LVI_INT(1);
lval var_57;
{
...
lval var_58[8];
var_58[0] = var_57;
var_57 = wile_add(NULL, var_58, "bld-rtl-dir/wile-rtl2-000073.scm:19");
}
var_42 = var_57;
var_41 = var_42;
goto lbl_39;
