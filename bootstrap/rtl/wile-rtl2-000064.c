...
{
lisp_int_t nq, nr;
floor_qr(var_2[0].v.iv, var_5.v.iv, &nq, &nr, "bld-rtl-dir/wile-rtl2-000064.scm:17");
var_6 = LVI_INT(nr);
}
var_4 = var_6;
lval var_7;
...
{
lisp_int_t nq, nr;
trunc_qr(var_2[0].v.iv, var_8.v.iv, &nq, &nr, "bld-rtl-dir/wile-rtl2-000064.scm:18");
var_9 = LVI_INT(nq);
}
var_7 = var_9;
lval var_10;
...
{
lisp_int_t nq, nr;
floor_qr(var_2[0].v.iv, var_11.v.iv, &nq, &nr, "bld-rtl-dir/wile-rtl2-000064.scm:19");
var_12 = LVI_INT(nr);
}
var_10 = var_12;
lval var_13;
...
{
lisp_int_t nq, nr;
trunc_qr(var_7.v.iv, var_14.v.iv, &nq, &nr, "bld-rtl-dir/wile-rtl2-000064.scm:20");
var_15 = LVI_INT(nq);
}
var_13 = var_15;
lval var_16;
...
{
lisp_int_t nq, nr;
floor_qr(var_7.v.iv, var_17.v.iv, &nq, &nr, "bld-rtl-dir/wile-rtl2-000064.scm:21");
var_18 = LVI_INT(nr);
}
var_16 = var_18;
lval var_19;
...
{
lisp_int_t nq, nr;
trunc_qr(var_21.v.iv, var_22.v.iv, &nq, &nr, "bld-rtl-dir/wile-rtl2-000064.scm:22");
var_23 = LVI_INT(nq);
}
var_19 = var_23;
lval var_24;
...
{
lisp_int_t nq, nr;
trunc_qr(var_27.v.iv, var_28.v.iv, &nq, &nr, "bld-rtl-dir/wile-rtl2-000064.scm:23");
var_29 = LVI_INT(nq);
}
var_24 = var_29;
lval var_30;
...
{
lisp_int_t nq, nr;
floor_qr(var_35.v.iv, var_36.v.iv, &nq, &nr, "bld-rtl-dir/wile-rtl2-000064.scm:24");
var_37 = LVI_INT(nr);
}
var_30 = var_37;
lval var_38;
...
{
lisp_int_t nq, nr;
trunc_qr(var_10.v.iv, var_39.v.iv, &nq, &nr, "bld-rtl-dir/wile-rtl2-000064.scm:25");
var_40 = LVI_INT(nq);
}
var_38 = var_40;
lval var_41;
...
{
lisp_int_t nq, nr;
floor_qr(var_10.v.iv, var_42.v.iv, &nq, &nr, "bld-rtl-dir/wile-rtl2-000064.scm:26");
var_43 = LVI_INT(nr);
}
var_41 = var_43;
lval var_44;
...
{
lisp_int_t nq, nr;
floor_qr(var_51.v.iv, var_52.v.iv, &nq, &nr, "bld-rtl-dir/wile-rtl2-000064.scm:27");
var_53 = LVI_INT(nr);
}
var_44 = var_53;
lval var_54;
...
{
lisp_int_t nq, nr;
trunc_qr(var_59.v.iv, var_60.v.iv, &nq, &nr, "bld-rtl-dir/wile-rtl2-000064.scm:28");
var_61 = LVI_INT(nq);
}
var_54 = var_61;
lval var_62;
...
lval var_70[2];
lisp_int_t nq, nr;
trunc_qr(var_67.v.iv, var_68.v.iv, &nq, &nr, "bld-rtl-dir/wile-rtl2-000064.scm:29");
var_70[0] = LVI_INT(nq);
var_70[1] = LVI_INT(nr);
...
wile_exception("car", "bld-rtl-dir/wile-rtl2-000064.scm:30", "input is not a pair!");
}
...
wile_exception("cxr", "bld-rtl-dir/wile-rtl2-000064.scm:31", "input does not have the right structure!");
}
if (*cp == 'a') {
...
wile_exception("cxr", "bld-rtl-dir/wile-rtl2-000064.scm:31", "got malformed control string '%s'", var_74.v.str);
}
}
}
lval var_76;
