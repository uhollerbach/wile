...
// @@@ lambda (x) @@@ bld-rtl-dir/wile-rtl2-000030.scm:14 @@@ fn_5 @@@
...
// @@@ promote/rat @@@ bld-rtl-dir/wile-rtl2-000030.scm:14 @@@ fn_9 @@@
...
// @@@ promote/real @@@ bld-rtl-dir/wile-rtl2-000030.scm:14 @@@ fn_14 @@@
...
// @@@ min/i @@@ bld-rtl-dir/wile-rtl2-000030.scm:15 @@@ fn_21 @@@
...
// @@@ min/q @@@ bld-rtl-dir/wile-rtl2-000030.scm:15 @@@ fn_26 @@@
...
// @@@ min/r @@@ bld-rtl-dir/wile-rtl2-000030.scm:15 @@@ fn_31 @@@
...
// @@@ max/i @@@ bld-rtl-dir/wile-rtl2-000030.scm:22 @@@ fn_53 @@@
...
// @@@ number/type @@@ bld-rtl-dir/wile-rtl2-000030.scm:22 @@@ fn_59 @@@
...
// @@@ (min . vs) @@@ bld-rtl-dir/wile-rtl2-000030.scm:13 @@@ wile_min @@@
lval wile_min(lptr* var_1, lptr var_2)
{
lval var_4;
lptr var_6[0];
lval var_19;
...
lval var_49;
var_49 = LVI_STRING("min got a non-real argument");
lval var_50;
{
lval vs[1];
vs[0] = var_49;
var_50 = gen_list(1, vs, NULL);
}
...
lval var_69;
var_69 = LVI_STRING("min got a non-real argument");
lval var_70;
{
lval vs[1];
vs[0] = var_69;
var_70 = gen_list(1, vs, NULL);
}
