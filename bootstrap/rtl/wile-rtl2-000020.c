...
wile_exception("vector-length", "bld-rtl-dir/wile-rtl2-000020.scm:14", "input is not a vector");
}
}
var_4 = var_5;
lval var_6;
...
break;
default:
wile_exception("zero?", "bld-rtl-dir/wile-rtl2-000020.scm:16", "expects a real-valued number");
}
