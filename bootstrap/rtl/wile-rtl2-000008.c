...
lval var_10[8];
var_10[0] = var_8;
var_9 = wile_list_reverse(NULL, var_10);
}
var_8 = var_9;
lval var_11;
if (var_8.vt != LV_PAIR) {
...
var_21 = (var_8.v.pair.car ? *(var_8.v.pair.car) : LVI_NIL());
lval var_22;
{
lval var_23[8];
var_23[0] = var_21;
var_22 = wile_list_reverse(NULL, var_23);
}
var_20 = var_22;
lval var_25;
lval var_26;
...
do {
lval var_28;
var_28 = LVI_BOOL(var_20.vt == LV_NIL);
lval var_29;
var_29 = LVI_BOOL(LV_IS_FALSE(var_28));
lval var_30;
var_30 = LVI_BOOL(LV_IS_FALSE(var_29));
...
var_31 = (var_20.v.pair.car ? *(var_20.v.pair.car) : LVI_NIL());
lval var_32;
{
...
var_33 = (var_20.v.pair.cdr ? *(var_20.v.pair.cdr) : LVI_NIL());
var_20 = var_33;
lval var_34;
var_34 = LVI_INT(1);
lval var_35;
...
var_37 = LVI_INT(1);
lval var_38;
var_38 = LVI_INT(var_14.v.iv + var_37.v.iv);
var_15 = var_38;
var_14 = var_15;
} while (1);
var_4 = var_6;
