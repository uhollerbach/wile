...
// @@@ lambda (d s) @@@ bld-rtl-dir/wile-rtl2-000081.scm:23 @@@ fn_34 @@@
...
lval var_44[8];
var_44[0] = var_43;
// bld-rtl-dir/wile-rtl2-000081.scm:25
var_43 = wile_divide(NULL, var_44, "bld-rtl-dir/wile-rtl2-000081.scm:25");
}
lval var_46;
var_46 = LVI_INT(1);
lval var_47;
...
var_48[0] = var_47;
// bld-rtl-dir/wile-rtl2-000081.scm:25
var_47 = wile_add(NULL, var_48, "bld-rtl-dir/wile-rtl2-000081.scm:25");
}
lval var_50;
{
lval var_51[2];
...
// @@@ lambda (kk) @@@ bld-rtl-dir/wile-rtl2-000081.scm:30 @@@ fn_67 @@@
...
lval var_77[8];
var_77[0] = var_76;
// bld-rtl-dir/wile-rtl2-000081.scm:33
var_76 = wile_subtract(NULL, var_77, "bld-rtl-dir/wile-rtl2-000081.scm:33");
}
lval var_80;
if (var_74.vt == LV_INT) {
...
// bld-rtl-dir/wile-rtl2-000081.scm:34
var_84 = wile_expmod(NULL, var_85, "bld-rtl-dir/wile-rtl2-000081.scm:34");
}
var_83 = var_84;
lval var_86;
lval var_87;
...
lval var_97[8];
var_97[0] = var_96;
// bld-rtl-dir/wile-rtl2-000081.scm:37
var_96 = wile_subtract(NULL, var_97, "bld-rtl-dir/wile-rtl2-000081.scm:37");
}
lval var_99;
{
lval var_100[1];
...
// @@@ lambda (ss x kk) @@@ bld-rtl-dir/wile-rtl2-000081.scm:39 @@@ fn_110 @@@
...
// bld-rtl-dir/wile-rtl2-000081.scm:42
var_118 = wile_expmod(NULL, var_119, "bld-rtl-dir/wile-rtl2-000081.scm:42");
}
var_116 = var_118;
lval var_120;
do {
...
lval var_127[8];
var_127[0] = var_126;
// bld-rtl-dir/wile-rtl2-000081.scm:44
var_126 = wile_subtract(NULL, var_127, "bld-rtl-dir/wile-rtl2-000081.scm:44");
}
lval var_129;
{
lval var_130[1];
...
lval var_135[8];
var_135[0] = var_134;
// bld-rtl-dir/wile-rtl2-000081.scm:45
var_134 = wile_subtract(NULL, var_135, "bld-rtl-dir/wile-rtl2-000081.scm:45");
}
lval var_137;
{
lval var_138[3];
...
// @@@ (is-prime? n . k) @@@ bld-rtl-dir/wile-rtl2-000081.scm:15 @@@ wile_mr_primality @@@
...
lval var_12[8];
var_12[0] = var_11;
// bld-rtl-dir/wile-rtl2-000081.scm:17
var_11 = wile_subtract(NULL, var_12, "bld-rtl-dir/wile-rtl2-000081.scm:17");
}
var_2[0] = var_11;
(void)
 var_2[0];
...
lval var_32[8];
var_32[0] = var_31;
// bld-rtl-dir/wile-rtl2-000081.scm:22
var_31 = wile_subtract(NULL, var_32, "bld-rtl-dir/wile-rtl2-000081.scm:22");
}
var_23 = var_31;
MK_CLOS(var_35,1);
...
lval var_65[8];
var_65[0] = var_64;
// bld-rtl-dir/wile-rtl2-000081.scm:29
var_64 = wile_subtract(NULL, var_65, "bld-rtl-dir/wile-rtl2-000081.scm:29");
}
var_27 = var_64;
MK_CLOS(var_68,6);
...
// @@@ (next-prime n) @@@ bld-rtl-dir/wile-rtl2-000081.scm:50 @@@ wile_next_prime @@@
...
var_151[0] = var_147[0];
var_151[1] = LVI_NIL();
// bld-rtl-dir/wile-rtl2-000081.scm:51
var_150 = wile_mr_primality(NULL, var_151, "bld-rtl-dir/wile-rtl2-000081.scm:51");
...
lval var_159[8];
var_159[0] = var_158;
// bld-rtl-dir/wile-rtl2-000081.scm:53
var_158 = wile_add(NULL, var_159, "bld-rtl-dir/wile-rtl2-000081.scm:53");
}
lval var_163[8];
var_163[0] = var_158;
var_147[0] = var_163[0];
