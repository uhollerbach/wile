...
vs[1] = var_53;
vs[2] = var_57;
var_58 = gen_list(3, vs, NULL);
}
{
lval vs[6];
vs[0] = var_58;
var_58 = wile_write_string(NULL, vs);
}
goto lbl_52;	// selfie
}
return var_55;
...
lval var_62;
lval var_63[6];
var_62 = fn_49(var_50, var_63);
return var_62;
}
// end of function wile_display_stack_trace

// lambda (acc)
static lval fn_92(lptr* var_93, lptr var_94)
{
lbl_95:;
lval var_96;
lval var_97;
...
lval vs[6];
vs[0] = var_94[0];
var_99 = wile_list_reverse(NULL, vs);
}
var_98 = var_99;
} else {
lval var_100;
...
// (stack-trace port)
lval wile_stack_trace(lptr* var_65, lptr var_66)
{
lval var_68;
lval var_69;
var_69 = LVI_STRING("wile-scratch.XXXXXX");
lval var_70;
{
lval vs[6];
vs[0] = var_69;
var_70 = wile_temp_file(NULL, vs);
}
var_68 = var_70;
lval var_71;
lval var_72;
...
var_72 = (var_68.v.pair.car ? *(var_68.v.pair.car) : LVI_NIL());
var_71 = var_72;
lval var_73;
lval var_74;
...
WILE_EX("cxr", "got malformed control string '%s'", var_74.v.str);
}
}
}
var_73 = var_75;
...
(void)
 LVI_BOOL(false);
(void)
 LVI_BOOL(unlink(var_73.v.str) == 0);
wile_stack_trace_minimal(fileno((var_71.vt == LV_FILE_PORT) ? var_71.v.fp : stderr));
(void)
 LVI_NIL();
{
lval vs[6];
...
var_66[0] = var_111[0];
var_66[1] = var_111[1];
TAIL_CALL wile_display_stack_trace(NULL, var_66);
}
