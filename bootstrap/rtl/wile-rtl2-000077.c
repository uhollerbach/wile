...
// @@@ (bracket-error) @@@ bld-rtl-dir/wile-rtl2-000077.scm:13 @@@ fn_1 @@@
...
// @@@ (budget-error val) @@@ bld-rtl-dir/wile-rtl2-000077.scm:16 @@@ fn_2 @@@
...
// @@@ (exact v) @@@ bld-rtl-dir/wile-rtl2-000077.scm:19 @@@ fn_3 @@@
...
// @@@ (approx v v1 v2) @@@ bld-rtl-dir/wile-rtl2-000077.scm:22 @@@ fn_4 @@@
...
lval var_29[8];
var_29[0] = var_28;
// bld-rtl-dir/wile-rtl2-000077.scm:23
var_28 = wile_subtract(NULL, var_29, "bld-rtl-dir/wile-rtl2-000077.scm:23");
}
lval var_31;
switch (var_28.vt) {
case LV_INT:
...
// @@@ lambda (s) @@@ bld-rtl-dir/wile-rtl2-000077.scm:28 @@@ fn_37 @@@
...
lval var_43[8];
var_43[0] = var_42;
// bld-rtl-dir/wile-rtl2-000077.scm:29
var_42 = wile_subtract(NULL, var_43, "bld-rtl-dir/wile-rtl2-000077.scm:29");
}
var_41 = var_42;
lval var_45;
lval var_46;
...
lval var_47[8];
var_47[0] = var_46;
// bld-rtl-dir/wile-rtl2-000077.scm:30
var_46 = wile_add(NULL, var_47, "bld-rtl-dir/wile-rtl2-000077.scm:30");
}
var_45 = var_46;
lval var_49;
lval var_50;
...
var_64 = wile_multiply(NULL, var_65, "bld-rtl-dir/wile-rtl2-000077.scm:35");
}
lval var_69[8];
var_69[0] = var_64;
var_39[0] = var_69[0];
...
// @@@ (root-bracket f x scale) @@@ bld-rtl-dir/wile-rtl2-000077.scm:27 @@@ wile_root_bracket @@@
...
lval var_75[8];
var_75[0] = var_35[2];
// bld-rtl-dir/wile-rtl2-000077.scm:28
var_74 = fn_37(var_38, var_75, "bld-rtl-dir/wile-rtl2-000077.scm:28");
*var_72 = var_35[0];
*var_73 = var_35[1];
return var_74;
}
...
// @@@ lambda (ne a fa b fb) @@@ bld-rtl-dir/wile-rtl2-000077.scm:45 @@@ fn_93 @@@
...
var_99 = wile_add(NULL, var_100, "bld-rtl-dir/wile-rtl2-000077.scm:46");
}
lval var_102;
{
lval var_104[2];
...
var_103[0] = var_102;
// bld-rtl-dir/wile-rtl2-000077.scm:46
var_102 = wile_multiply(NULL, var_103, "bld-rtl-dir/wile-rtl2-000077.scm:46");
}
var_97 = var_102;
lval var_105;
lval var_106;
...
var_112[1] = var_95[1];
var_112[2] = var_95[3];
// bld-rtl-dir/wile-rtl2-000077.scm:48
var_111 = fn_4(NULL, var_112, "bld-rtl-dir/wile-rtl2-000077.scm:48");
var_110 = var_111;
lval var_114;
lval var_115;
var_115 = LVI_INT(1);
...
lval var_117[8];
var_117[0] = var_116;
// bld-rtl-dir/wile-rtl2-000077.scm:49
var_116 = wile_subtract(NULL, var_117, "bld-rtl-dir/wile-rtl2-000077.scm:49");
}
var_114 = var_116;
lval var_119;
do {
...
var_123[0] = var_110;
var_95[0] = var_123[0];
// bld-rtl-dir/wile-rtl2-000077.scm:50
TAIL_CALL fn_2(NULL, var_95, "bld-rtl-dir/wile-rtl2-000077.scm:50");
}
lval var_124;
switch (var_105.vt) {
case LV_REAL:
...
var_127[0] = var_97;
var_95[0] = var_127[0];
// bld-rtl-dir/wile-rtl2-000077.scm:51
TAIL_CALL fn_3(NULL, var_95, "bld-rtl-dir/wile-rtl2-000077.scm:51");
}
lval var_128;
{
lval var_129[2];
...
// @@@ (root-bisect et fn a0 b0) @@@ bld-rtl-dir/wile-rtl2-000077.scm:41 @@@ wile_root_bisect @@@
...
var_148[0] = var_78[2];
var_78[0] = var_148[0];
// bld-rtl-dir/wile-rtl2-000077.scm:55
TAIL_CALL fn_3(NULL, var_78, "bld-rtl-dir/wile-rtl2-000077.scm:55");
}
lval var_149;
switch (var_81.vt) {
case LV_REAL:
...
TAIL_CALL fn_3(NULL, var_78, "bld-rtl-dir/wile-rtl2-000077.scm:56");
}
lval var_153;
switch (var_80.vt) {
case LV_INT:
...
TAIL_CALL fn_1(NULL, var_78, "bld-rtl-dir/wile-rtl2-000077.scm:57");
}
lval var_159;
switch (var_80.vt) {
case LV_REAL:
...
// @@@ lambda (ne a fa b fb) @@@ bld-rtl-dir/wile-rtl2-000077.scm:94 @@@ fn_184 @@@
...
lval var_191[8];
var_191[0] = var_190;
// bld-rtl-dir/wile-rtl2-000077.scm:95
var_190 = wile_add(NULL, var_191, "bld-rtl-dir/wile-rtl2-000077.scm:95");
}
lval var_193;
{
lval var_195[2];
...
var_194[0] = var_193;
// bld-rtl-dir/wile-rtl2-000077.scm:95
var_193 = wile_multiply(NULL, var_194, "bld-rtl-dir/wile-rtl2-000077.scm:95");
}
var_188 = var_193;
lval var_196;
lval var_197;
...
lval var_203[8];
var_203[0] = var_202;
// bld-rtl-dir/wile-rtl2-000077.scm:97
var_202 = wile_subtract(NULL, var_203, "bld-rtl-dir/wile-rtl2-000077.scm:97");
}
lval var_205;
{
lval var_207[2];
...
var_206[0] = var_205;
// bld-rtl-dir/wile-rtl2-000077.scm:97
var_205 = wile_subtract(NULL, var_206, "bld-rtl-dir/wile-rtl2-000077.scm:97");
}
lval var_208;
switch (var_205.vt) {
case LV_INT:
...
var_210[0] = var_209;
// bld-rtl-dir/wile-rtl2-000077.scm:97
var_209 = wile_multiply(NULL, var_210, "bld-rtl-dir/wile-rtl2-000077.scm:97");
}
lval var_212;
{
lval var_214[2];
...
lval var_213[8];
var_213[0] = var_212;
// bld-rtl-dir/wile-rtl2-000077.scm:98
var_212 = wile_multiply(NULL, var_213, "bld-rtl-dir/wile-rtl2-000077.scm:98");
}
lval var_215;
{
lval var_217[2];
...
var_216[0] = var_215;
// bld-rtl-dir/wile-rtl2-000077.scm:98
var_215 = wile_multiply(NULL, var_216, "bld-rtl-dir/wile-rtl2-000077.scm:98");
}
lval var_218;
{
lval var_220[2];
...
var_219[0] = var_218;
// bld-rtl-dir/wile-rtl2-000077.scm:98
var_218 = wile_subtract(NULL, var_219, "bld-rtl-dir/wile-rtl2-000077.scm:98");
}
lval var_222;
...
var_224[0] = var_223;
// bld-rtl-dir/wile-rtl2-000077.scm:97
var_223 = wile_divide(NULL, var_224, "bld-rtl-dir/wile-rtl2-000077.scm:97");
}
lval var_226;
{
lval var_228[2];
...
var_227[0] = var_226;
// bld-rtl-dir/wile-rtl2-000077.scm:97
var_226 = wile_add(NULL, var_227, "bld-rtl-dir/wile-rtl2-000077.scm:97");
}
var_201 = var_226;
lval var_229;
lval var_230;
...
var_236[1] = var_188;
var_236[2] = var_201;
// bld-rtl-dir/wile-rtl2-000077.scm:100
var_235 = fn_4(NULL, var_236, "bld-rtl-dir/wile-rtl2-000077.scm:100");
var_234 = var_235;
lval var_238;
lval var_239;
var_239 = LVI_INT(1);
...
lval var_241[8];
var_241[0] = var_240;
// bld-rtl-dir/wile-rtl2-000077.scm:101
var_240 = wile_subtract(NULL, var_241, "bld-rtl-dir/wile-rtl2-000077.scm:101");
}
var_238 = var_240;
lval var_243;
do {
...
var_247[0] = var_234;
var_186[0] = var_247[0];
// bld-rtl-dir/wile-rtl2-000077.scm:102
TAIL_CALL fn_2(NULL, var_186, "bld-rtl-dir/wile-rtl2-000077.scm:102");
}
lval var_248;
switch (var_196.vt) {
case LV_REAL:
...
var_251[0] = var_188;
var_186[0] = var_251[0];
// bld-rtl-dir/wile-rtl2-000077.scm:103
TAIL_CALL fn_3(NULL, var_186, "bld-rtl-dir/wile-rtl2-000077.scm:103");
}
lval var_252;
switch (var_229.vt) {
case LV_REAL:
...
var_255[0] = var_201;
var_186[0] = var_255[0];
// bld-rtl-dir/wile-rtl2-000077.scm:104
TAIL_CALL fn_3(NULL, var_186, "bld-rtl-dir/wile-rtl2-000077.scm:104");
}
lval var_256;
{
lval var_257[2];
...
// @@@ (root-ridders et fn a0 b0) @@@ bld-rtl-dir/wile-rtl2-000077.scm:90 @@@ wile_root_ridders @@@
...
var_285[0] = var_169[2];
var_169[0] = var_285[0];
// bld-rtl-dir/wile-rtl2-000077.scm:109
TAIL_CALL fn_3(NULL, var_169, "bld-rtl-dir/wile-rtl2-000077.scm:109");
}
lval var_286;
switch (var_172.vt) {
case LV_REAL:
...
var_289[0] = var_169[3];
var_169[0] = var_289[0];
// bld-rtl-dir/wile-rtl2-000077.scm:110
TAIL_CALL fn_3(NULL, var_169, "bld-rtl-dir/wile-rtl2-000077.scm:110");
}
lval var_290;
switch (var_171.vt) {
case LV_INT:
...
// bld-rtl-dir/wile-rtl2-000077.scm:111
TAIL_CALL fn_1(NULL, var_169, "bld-rtl-dir/wile-rtl2-000077.scm:111");
}
lval var_296;
{
lval var_297[5];
