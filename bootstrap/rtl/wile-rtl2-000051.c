...
// @@@ lambda (n acc) @@@ bld-rtl-dir/wile-rtl2-000051.scm:14 @@@ fn_4 @@@
...
break;
default:
wile_exception("<", "bld-rtl-dir/wile-rtl2-000051.scm:16", "inputs are not real-valued numbers");
break;
}
...
var_22[0] = var_19;
var_22[1] = var_20;
var_21 = fn_4(var_5, var_22, "bld-rtl-dir/wile-rtl2-000051.scm:14");
*var_16 = var_2[0];
return var_21;
}
