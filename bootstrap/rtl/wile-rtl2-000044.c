...
break;
default:
wile_exception("<", "bld-rtl-dir/wile-rtl2-000044.scm:15", "inputs are not real-valued numbers");
break;
}
...
lval var_11[8];
var_11[0] = var_10;
var_10 = wile_string_append(NULL, var_11, "bld-rtl-dir/wile-rtl2-000044.scm:16");
}
var_6 = var_10;
}
return var_6;
